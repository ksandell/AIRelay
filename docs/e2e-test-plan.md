...
— v0.4.0 tagged with only win32 baselines, CI red on `main`. Fixed in v0.4.1.)

To regenerate Linux baselines after an intentional UI change:

1. Dispatch the **Bless visual baselines** workflow
   (`.github/workflows/bless-visual.yml`) from the Actions tab on your
   branch.
